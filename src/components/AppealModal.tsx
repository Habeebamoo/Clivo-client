    ...
    <section className="bg-black/50 z-30 fixed top-0 bottom-0 left-0 right-0 flex-center">
      <div className="bg-white w-[90%] sm:w-100 p-4 border border-muted">
        ...
        <div className="mt-6">
          ...
          <p className="font-exo text-accent mt-2 text-sm">{userAppeal.message}</p>
        </div>
        ...
        <div className="mt-6 flex-start gap-2">
          ...
          <button className="bg-red-600 border border-red-600 cursor-pointer hover:bg-transparent hover:text-red-600 py-2 px-3 text-sm font-inter text-white rounded-md">
            Reject
          </button>
        </div>
      </div>
