    ...
    <main className="bg-center bg-cover min-h-screen">
      <div className="bg-white/70 inset-0">
        ...
        <div className="mt-18 pt-10 px-4">
          ...
          <p className="font-open text-accent text-sm font-interSm mt-3 mb-20 lg:mx-auto md:text-center lg:w-[50%]">Clivo is a platform for writers who demands excellence | Craft, Publish, and share your stories with a community that values quality</p>
          <PhotoGrid />
        </div>
        ...
        <div className="mt-20 pb-10 p-4">
          ...
          <p className="font-open text-sm text-center text-accent mt-2 lg:mx-auto md:text-center lg:w-[50%]">Join our community of discerning readers and receive carefully selected stories, writing insights, and exclusive content delivered to your inbox.</p>
