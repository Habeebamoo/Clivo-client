    ...
    <main className="bg-center bg-cover min-h-screen">
      <div className="bg-white/70 inset-0">
        ...
        <div className="mt-18 pt-10 px-4">
          ...
          <p className="text-accent font-outfit mt-3 mb-20 lg:mx-auto md:text-center lg:w-[50%]">Clivo is a platform for writers who demands excellence | Craft, Publish, and share your stories with a community that values quality</p>
          <PhotoGrid />
        </div>
