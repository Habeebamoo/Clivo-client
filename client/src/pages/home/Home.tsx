  ...
  return (
    <>
      ...
      <div className="mt-18 pt-10 px-4">
        ...
        <p className="text-accent font-inter mt-3 mb-10 max-sm:mb-15 text-sm lg:mx-auto md:text-center lg:w-[50%]">Clivo is a platform for writers who demands excellence. Craft, Publish, and share your stories with a community that values quality</p>
        <PhotoGrid />
      </div>
      ...
      <div className="mt-20 mb-10 p-4">
        ...
        <p className="text-sm font-inter text-center text-accent mt-2 lg:mx-auto md:text-center lg:w-[50%]">Join our community of discerning readers and receive carefully selected stories, writing insights, and exclusive content delivered to your inbox.</p>
